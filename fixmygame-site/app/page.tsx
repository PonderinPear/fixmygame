export default function FixMyGameWebsite() {
  ...
  const features = [
  {
    ...
    description:
      "Detect mod conflicts and broken logs instantly",
  },
  {
    title: "See the fix",
    description:
      "Clear next steps, not technical noise",
  },
  {
    title: "Fix it faster",
    description:
      "Get back in game without trial and error",
  },
  {
    title: "Keep it working",
    description:
      "Continue diagnostics and track what worked",
  },
];
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col px-6 py-6 md:px-10">
        <header className="flex items-center justify-between rounded-2xl border border-white/10 bg-white/5 px-4 py-3 backdrop-blur">
          <div>
            <div className="text-lg font-semibold tracking-tight">FixMyGame</div>
            <div className="text-xs text-white/55">AI crash diagnostics for modded PC games</div>
          </div>

          <nav className="hidden items-center gap-6 text-sm text-white/75 md:flex">
            <a href="#features" className="hover:text-white">Features</a>
            <a href="#supported" className="hover:text-white">Supported Games</a>
          ...
          <section className="grid items-center gap-10 py-16 md:grid-cols-[1.15fr_0.85fr] md:py-24">
            <div>
              ...
              <h1 className="mt-5 max-w-4xl text-5xl font-black tracking-tight md:text-7xl">
                Stop guessing.
                <span className="block text-cyan-300">Fix your modded game faster.</span>
              </h1>

              <p className="mt-6 max-w-2xl text-base leading-7 text-white/72 md:text-lg">
                FixMyGame reads crash logs, finds what likely went wrong, shows the next move,
                and helps users get back into the game faster.
              </p>
    ...
    Request Beta Access
              ...
              <div className="mt-10 grid gap-3 sm:grid-cols-3">
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                  ...
                  <div className="mt-1 text-sm text-white/60">Spot likely mod and log issues fast</div>
                </div>
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                  <div className="text-2xl font-bold text-violet-300">Fix</div>
                  <div className="mt-1 text-sm text-white/60">Clear next steps that feel usable</div>
                </div>
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                  <div className="text-2xl font-bold text-emerald-300">Play</div>
                  <div className="mt-1 text-sm text-white/60">Get back in game with less guessing</div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-[28px] border border-cyan-400/10 bg-slate-900/70 p-4 shadow-2xl shadow-cyan-950/40 backdrop-blur">
              <div className="rounded-[24px] border border-white/10 bg-[#071122] p-5">
                <div className="mb-4 flex items-center justify-between rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-3">
                  <div>
                    <div className="text-xs font-semibold tracking-[0.2em] text-cyan-200/80">FIXMYGAME</div>
                    <div className="mt-1 text-lg font-semibold">Diagnostic Preview</div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="rounded-2xl border border-cyan-400/15 bg-cyan-400/10 p-4">
                    <div className="text-xs font-semibold tracking-widest text-cyan-100/80">LIVE DETECTION</div>
                    <div className="mt-3 flex flex-wrap gap-2">
                      <span className="rounded-full border border-emerald-400/20 bg-emerald-400/10 px-3 py-1 text-xs text-emerald-200">Status: No clear issue</span>
                      <span className="rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-xs text-cyan-200">Session: Normal log</span>
                      <span className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-white/80">Mods loaded</span>
                    </div>
                  </div>

                  <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                    <div className="text-xs font-semibold tracking-widest text-white/55">SMART FIX PATH</div>
                    ...
                    <div className="mt-3 space-y-2 text-sm text-white/75">
                      <div className="rounded-xl border border-white/10 bg-black/20 px-3 py-3">This log looks normal and does not show an active crash or broken mod.</div>
                      <div className="rounded-xl border border-white/10 bg-black/20 px-3 py-3">Launch the game again and test normally.</div>
                      <div className="rounded-xl border border-white/10 bg-black/20 px-3 py-3">If the issue returns, load the newest crash or error log created after it happens.</div>
                    </div>
                  </div>

                  <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                    <div className="text-xs font-semibold tracking-widest text-white/55">DIAGNOSTIC RESULT</div>
                    <div className="mt-3 grid gap-3 sm:grid-cols-2">
                      <div className="rounded-xl border border-white/10 bg-black/20 p-3">
                        <div className="text-xs font-semibold tracking-widest text-white/50">ISSUE</div>
                        <div className="mt-2 text-sm text-white/85">No clear crash, broken mod, or missing dependency was found.</div>
                      </div>
                      <div className="rounded-xl border border-white/10 bg-black/20 p-3">
                        <div className="text-xs font-semibold tracking-widest text-white/50">CONFIDENCE</div>
                        <div className="mt-2 inline-flex rounded-full border border-emerald-400/20 bg-emerald-400/10 px-3 py-1 text-xs font-medium text-emerald-200">High</div>
                      </div>
                    </div>
                  </div>

                  <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                    <div className="text-xs font-semibold tracking-widest text-white/55">FIX HISTORY</div>
          ...
          <section id="features" className="py-8 md:py-14">
            <div className="mb-6">
              <div className="text-sm font-semibold uppercase tracking-[0.2em] text-cyan-200/70">Features</div>
              <h2 className="mt-2 text-3xl font-bold md:text-4xl">No more guessing what broke your game</h2>
            </div>

            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
              {features.map((feature) => (
                <div key={feature.title} className="rounded-[24px] border border-white/10 bg-white/5 p-5 backdrop-blur">
                  <div className="text-lg font-semibold">{feature.title}</div>
                  <p className="mt-3 text-sm leading-6 text-white/68">{feature.description}</p>
                </div>
              ))}
            </div>
          </section>
...
<section className="py-8 md:py-14">
        ...
        {item}
          ...
          <section id="supported" className="py-8 md:py-14">
            <div className="rounded-[28px] border border-white/10 bg-white/5 p-6 md:p-8">
              <div className="text-sm font-semibold uppercase tracking-[0.2em] text-violet-200/70">Supported Games</div>
              <h2 className="mt-2 text-3xl font-bold md:text-4xl">Growing multi-game support</h2>
  ...
  <div className="rounded-[28px] border border-white/10 bg-cyan-400/10 p-6 md:p-8">
    ...
    <p className="mt-3 max-w-2xl text-white/72">
      FixMyGame is currently in private Windows beta. Access is approved manually, so only invited testers can download and try builds during this phase.
    </p>
    ...
    <p className="mt-4 text-sm text-white/50">
      Approved testers receive the Windows beta build directly.
          ...
          <section id="faq" className="py-8 md:py-14">
            <div className="mb-6">
              <div className="text-sm font-semibold uppercase tracking-[0.2em] text-orange-200/70">FAQ</div>
              <h2 className="mt-2 text-3xl font-bold md:text-4xl">Questions users will ask</h2>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {faqs.map((faq) => (
                <div key={faq.q} className="rounded-[24px] border border-white/10 bg-white/5 p-5">
                  ...
                  <p className="mt-3 text-sm leading-6 text-white/68">{faq.a}</p>
                </div>
              ))}
            </div>
          </section>
